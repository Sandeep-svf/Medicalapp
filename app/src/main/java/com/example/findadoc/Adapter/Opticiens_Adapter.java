...
import com.example.findadoc.Model.dev.sam.Opticians_Response;
...
public class Opticiens_Adapter extends RecyclerView.Adapter<Opticiens_Adapter.MyView_Holder> {
    Context context;
    ...
    public  Opticiens_Adapter(Context context, List<Pharmacies_Data_Response> hospital_resposnes , String key) {
    ...
    public void onBindViewHolder(@NonNull MyView_Holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(pharmacies_data_responses.get(position).getOpticianImage()!=null)
        {
            Glide.with(context).load(
                    Api_client.BASE_IMAGE+pharmacies_data_responses.get(position).
                            getOpticianImage()).into(holder.image);
        }
        else
        {
            Glide.with(context).load(
        ...
        holder.number.setText(pharmacies_data_responses.get(position).getOpticianPhone());
        holder.opticiens_timing.setText(pharmacies_data_responses.get(position).getOpticianTiming());
        holder.address.setText(pharmacies_data_responses.get(position).getOpticianAdd());
        holder.heading_text.setText(pharmacies_data_responses.get(position).getOpticianName());

        String temp = pharmacies_data_responses.get(position).getOpticianTiming();
        if(temp.contains("00:00-00:00"))
        {
            holder.opticiens_timing.setText("24 Hours");
        ...
        holder.call_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callIntent.setData(Uri.parse("tel:"+pharmacies_data_responses.get(position).getOpticianPhone()));//change the number
        ...
        holder.share_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                share.putExtra(Intent.EXTRA_TEXT, pharmacies_data_responses.get(position).getOpticianName()+"\n"+pharmacies_data_responses.get(position).getOpticianAdd()+"\n"+pharmacies_data_responses.get(position).getOpticianPhone());
//                share.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        holder.location_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("lattitude",pharmacies_data_responses.get(position).getOpticianLatitude());
                intent.putExtra("longitude",pharmacies_data_responses.get(position).getOpticianLongitude());
                intent.putExtra("city",pharmacies_data_responses.get(position).getOpticianCityName());
        ...
        holder.add_fav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String hospital_id= String.valueOf(pharmacies_data_responses.get(position).getOpticianId());
...
// Working code ---->
        ...
        holder.recommen_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String hosp_id=pharmacies_data_responses.get(position).getOpticianId().toString();
                String prevoud_count= String.valueOf(pharmacies_data_responses.get(position).getOpticianRecommend());
                if(person_id.equals(""))
                {
                    Intent intent=new Intent(context, Login_Activity.class);
                    context.startActivity(intent);
...
//                    Recommend_API(hosp_id,prevoud_count,person_id);
    ...
    private void add_favourite_API(int position, String hospital_id, ImageView add_fav) {
        ...
        Call<Advance_Search_Model> call = Api_client.getClient().save_as_favourite_API( "7c538f486ea815187d12c54c3646d71e",person_id,"8",hospital_id,language);
    ...
    public class MyView_Holder extends RecyclerView.ViewHolder {
        TextView heading_text,address,number , opticiens_timing,sun , mon , tue, wed , thu , fri , sat;
        ...
        public MyView_Holder(View view) {
            ...
            opticiens_timing =view.findViewById(R.id.hospital_timing);
