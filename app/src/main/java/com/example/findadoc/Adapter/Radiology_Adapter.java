...
public class Radiology_Adapter extends RecyclerView.Adapter<Radiology_Adapter.My_View_Holder> {
        Context context;
    ...
    public Radiology_Adapter(Context context, List<Radiology_Response> clinic_responses) {
            this.context = context;
            this.radiology_responses = clinic_responses;
        }
        ...
        public void onBindViewHolder(@NonNull My_View_Holder holder, @SuppressLint("RecyclerView") int position) {
            ...
            if(radiology_responses.get(position).getRadCenterImage()!=null)
            {
                Glide.with(context).load(Api_client.BASE_IMAGE+radiology_responses.get(position).getRadCenterImage()).into(holder.image);
            }
            else
            {
            ...
            Sun = String.valueOf(radiology_responses.get(position).getSun());
            Mon = String.valueOf(radiology_responses.get(position).getMon());
            Tue = String.valueOf(radiology_responses.get(position).getTue());
            Wed = String.valueOf(radiology_responses.get(position).getWed());
            Thu = String.valueOf(radiology_responses.get(position).getThu());
            Fri = String.valueOf(radiology_responses.get(position).getFri());
            Sat = String.valueOf(radiology_responses.get(position).getSat());
            ...
            holder.number.setText(radiology_responses.get(position).getRadCenterPhone()+"");
            holder.address.setText(radiology_responses.get(position).getRadCenterAddress());
            holder.radiology_timing.setText(radiology_responses.get(position).getRadCenterTiming());
            holder.heading_text.setText(radiology_responses.get(position).getRadCenterName());

            if(radiology_responses.get(position).getRadCenterTiming().contains("00:00-00:00"))
            {
                holder.radiology_timing.setText("24 hours");
            ...
            holder.call_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    callIntent.setData(Uri.parse("tel:"+radiology_responses.get(position).getRadCenterPhone()));//change the number
            ...
            holder.share_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    share.putExtra(Intent.EXTRA_TEXT, radiology_responses.get(position).getRadCenterName()+"\n"+radiology_responses.get(position).getRadCenterAddress()+"\n"+radiology_responses.get(position).getRadCenterPhone());
//                share.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            holder.location_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("lattitude",radiology_responses.get(position).getRadCenterLatitude());
                    intent.putExtra("longitude",radiology_responses.get(position).getRadCenterLongitude());
                    intent.putExtra("city",radiology_responses.get(position).getRadCenterName());
                    intent.putExtra("key","2");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    context.startActivity(intent);
                }
            });
            String fav_result=radiology_responses.get(position).getFavourite()+"";
            ...
            holder.add_fav.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String radio_id=radiology_responses.get(position).getRadiologyCenterId().toString();
                    ...
                    {
                        String fav_status= String.valueOf(radiology_responses.get(position).getFavourite());

                            add_favourite_API(position,radio_id,holder.add_fav);
            ...
            holder.recommen_icon.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String rad_id=radiology_responses.get(position).getRadiologyCenterId().toString();
                    String prevoud_count= String.valueOf(radiology_responses.get(position).getRadCenterRecommend());
                    if(person_id.equals(""))
                    {
                        Intent intent=new Intent(context, Login_Activity.class);
                        context.startActivity(intent);
                    ...
                    else
                    {
                        ...
                        Recommend_API(rad_id,prevoud_count,person_id);
    ...
    private void Recommend_API(String rad_id, String prevoud_count, String person_id) {
        ...
        Call<Fav_Model> call = Api_client.getClient().get_recommend("7c538f486ea815187d12c54c3646d71e","5",rad_id,person_id,prevoud_count,language);
    ...
    private void add_favourite_API(int position, String radio_id, ImageView add_fav) {
        ...
        Call<Advance_Search_Model> call = Api_client.getClient().save_as_favourite_API( "7c538f486ea815187d12c54c3646d71e",person_id,"5",radio_id,language);
        ...
        public int getItemCount() {
            return radiology_responses.size();
        }

        public class My_View_Holder extends RecyclerView.ViewHolder {
            TextView heading_text,address,number , radiology_timing ,  sun , mon , tue, wed , thu , fri , sat;
            ...
            public My_View_Holder(@NonNull View view) {
                ...
                radiology_timing=view.findViewById(R.id.hospital_timing);
