...
import com.example.findadoc.Fragments.Pharmacy_on_duty_fav;
...
public class Duty_Fav_Adapter extends RecyclerView.Adapter<Duty_Fav_Adapter.My_View_Holder> {

    Context context;
    List<Fav_Response> duty_response;
    SharedPreferences sharedPreferences;
    String person_id="";
    private String pharmacy_on_duty_fav_id, prevoud_count;
    Pharmacy_on_duty_fav pharmacy_on_duty_fav;
    private String language="en";
    AlertDialog dialogs;

    public Duty_Fav_Adapter(Context context, List<Fav_Response> fav_responses, Pharmacy_on_duty_fav pharmacy_on_duty_fav) {
        this.context = context;
        this.duty_response = fav_responses;
        this.pharmacy_on_duty_fav=pharmacy_on_duty_fav;
    }
    ...
    public void onBindViewHolder(@NonNull My_View_Holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(duty_response.get(position).getPharmacyGuardImage()!=null)
        {
            Glide.with(context).load(Api_client.BASE_IMAGE+duty_response.get(position).getPharmacyGuardImage()).into(holder.image);
        }
        else
        {
            Glide.with(context).load(R.drawable.profile).into(holder.image);
        }
        holder.number.setText(duty_response.get(position).getPharmacyGuardPhone()+"");
        holder.address.setText(duty_response.get(position).getPharmacyGuardAdd());
        holder.heading_text.setText(duty_response.get(position).getPharmacyGuardName());
        holder.call_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent callIntent = new Intent(Intent.ACTION_DIAL);
                callIntent.setData(Uri.parse("tel:"+duty_response.get(position).getPharmacyGuardPhone()));//change the number
        ...
        holder.share_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                share.putExtra(Intent.EXTRA_TEXT, duty_response.get(position).getPharmacyGuardName()+"\n"+duty_response.get(position).getPharmacyGuardAdd()+"\n"+duty_response.get(position).getPharmacyGuardPhone());
//                share.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        holder.location_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("lattitude",duty_response.get(position).getPharmacyGuardLatitude());
                intent.putExtra("longitude",duty_response.get(position).getPharmacyGuardLongitude());
                intent.putExtra("city",duty_response.get(position).getPharmacyGuardCityName());
        ...
        holder.layout_one.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String dr_id= String.valueOf(duty_response.get(position).getPharmacyGuardId());
...
*/
       ...
       /* holder.recommen_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Recommend_API(pharmacy_on_duty_fav_id,prevoud_count,person_id);
        ...
        holder.add_remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String h_id= String.valueOf(duty_response.get(position).getPharmacyGuardId());
    ...
    private void Recommend_API(String pharmacy_on_duty_fav_id, String prevoud_count, String person_id) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True")) {
                            Toast.makeText(context, message, Toast.LENGTH_SHORT).show();
                            removeItem(position);
                            pharmacy_on_duty_fav.getFav_API_Data();
