...
public class Laboratory_Data_Adapter extends RecyclerView.Adapter<Laboratory_Data_Adapter.My_View_Holder> {
        Context context;
        List<Lab_Response> clinic_responses;
    SharedPreferences sharedPreferences;
    String person_id="";
    private String language="en";
    private String Sun, Mon, Tue, Wed , Thu , Fri , Sat ;

    public Laboratory_Data_Adapter(Context context, List<Lab_Response> clinic_responses) {
        ...
        public void onBindViewHolder(@NonNull My_View_Holder holder, @SuppressLint("RecyclerView") int position) {
            ...
            if(clinic_responses.get(position).getLaboratoryImage()!=null)
            {
                Glide.with(context).load(Api_client.BASE_IMAGE+clinic_responses.get(position).getLaboratoryImage()).into(holder.image);
            }
            else
            {
            ...
            holder.number.setText(clinic_responses.get(position).getLaboratoryPhone()+"");
            holder.address.setText(clinic_responses.get(position).getLaboratoryAddress());
            holder.laboratoryTime.setText(clinic_responses.get(position).getLaboratoryTime());
            holder.heading_text.setText(clinic_responses.get(position).getLaboratoryName());

            if(clinic_responses.get(position).getLaboratoryTime().contains("00:00-00:00"))
            {
                holder.dev_sam.setVisibility(View.GONE);
                holder.laboratoryTime.setText("24 hours");
            ...
            holder.call_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    callIntent.setData(Uri.parse("tel:"+clinic_responses.get(position).getLaboratoryPhone()));//change the number
            ...
            holder.recommen_icon.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String lab_id=clinic_responses.get(position).getLaboratoryId().toString();
                    String prevoud_count= String.valueOf(clinic_responses.get(position).getLaboratoryRecommend());
                    if(person_id.equals(""))
                    {
                    ...
                    else
                    {
                        ...
                        Recommend_API(lab_id,prevoud_count,person_id);
            ...
            holder.share_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    share.putExtra(Intent.EXTRA_TEXT, clinic_responses.get(position).getLaboratoryName()+"\n"+clinic_responses.get(position).getLaboratoryAddress()+"\n"+clinic_responses.get(position).getLaboratoryPhone());
//                share.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            holder.location_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("lattitude",clinic_responses.get(position).getLaboratoryLatitude());
                    intent.putExtra("longitude",clinic_responses.get(position).getLaboratoryLongitude());
                    intent.putExtra("city",clinic_responses.get(position).getLaboratoryName());
            ...
            holder.add_fav.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        String fav_status= String.valueOf(clinic_responses.get(position).getFavourite());


                            add_favourite_API(position,lab_id,holder.add_fav);
    ...
    private void Recommend_API(String lab_id, String prevoud_count, String person_id) {
        ...
        Call<Fav_Model> call = Api_client.getClient().get_recommend("7c538f486ea815187d12c54c3646d71e","4",lab_id,person_id,prevoud_count,language);
    ...
    private void add_favourite_API(int position, String lab_id, ImageView add_fav) {
        ...
        Call<Advance_Search_Model> call = Api_client.getClient().save_as_favourite_API( "7c538f486ea815187d12c54c3646d71e",person_id,"4",lab_id,language);
        ...
        public class My_View_Holder extends RecyclerView.ViewHolder {
            TextView heading_text,address,number , laboratoryTime,  sun , mon , tue, wed , thu , fri , sat;
            ...
            public My_View_Holder(@NonNull View view) {
                ...
                laboratoryTime=view.findViewById(R.id.hospital_timing);
