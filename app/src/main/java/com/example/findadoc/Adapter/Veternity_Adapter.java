...
public class Veternity_Adapter extends RecyclerView.Adapter<Veternity_Adapter.MyView_Holder> {
    Context context;
    ...
    public  Veternity_Adapter(Context context, List<Pharmacies_Data_Response> hospital_resposnes , String key) {
    ...
    public void onBindViewHolder(@NonNull MyView_Holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(pharmacies_data_responses.get(position).getVeterinaryImage()!=null)
        {
            Glide.with(context).load(
                    Api_client.BASE_IMAGE+pharmacies_data_responses.get(position).
                            getVeterinaryImage()).into(holder.image);
        }
        else
        {
            Glide.with(context).load(
        ...
        holder.number.setText(pharmacies_data_responses.get(position).getVeterinaryPhone());
        holder.veternity_timing.setText(pharmacies_data_responses.get(position).getVeterinaryTiming());
        holder.address.setText(pharmacies_data_responses.get(position).getVeterinaryAdd());
        holder.heading_text.setText(pharmacies_data_responses.get(position).getVeterinaryName());

        String temp = pharmacies_data_responses.get(position).getVeterinaryTiming();
        if(temp.contains("00:00-00:00"))
        {
            holder.veternity_timing.setText("24 Hours");
        ...
        holder.call_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callIntent.setData(Uri.parse("tel:"+pharmacies_data_responses.get(position).getVeterinaryPhone()));//change the number
        ...
        holder.share_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                share.putExtra(Intent.EXTRA_TEXT, pharmacies_data_responses.get(position).getVeterinaryName()+"\n"+pharmacies_data_responses.get(position).getVeterinaryAdd()+"\n"+pharmacies_data_responses.get(position).getVeterinaryPhone());
//                share.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        holder.location_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("lattitude",pharmacies_data_responses.get(position).getVeterinaryLatitude());
                intent.putExtra("longitude",pharmacies_data_responses.get(position).getVeterinaryLongitude());
                intent.putExtra("city",pharmacies_data_responses.get(position).getVeterinaryCityName());
        ...
        holder.add_fav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String hospital_id= String.valueOf(pharmacies_data_responses.get(position).getVeterinaryId());
                if(person_id.equals(""))
                {
...
*/
        ...
        holder.recommen_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               // String hosp_id=Pharmacies_Data_Response.get(position).getOpticianId().toString();
                String hosp_id= pharmacies_data_responses.get(position).getVeterinaryId().toString();
                String prevoud_count= String.valueOf(pharmacies_data_responses.get(position).getVeterinaryRecommend());
                if(person_id.equals(""))
                {
                    Intent intent=new Intent(context, Login_Activity.class);
                    context.startActivity(intent);
...
//                    Recommend_API(hosp_id,prevoud_count,person_id);
    ...
    private void add_favourite_API(int position, String hospital_id, ImageView add_fav) {
        ...
        Call<Advance_Search_Model> call = Api_client.getClient().save_as_favourite_API( "7c538f486ea815187d12c54c3646d71e",person_id,"9",hospital_id,language);
    ...
    public class MyView_Holder extends RecyclerView.ViewHolder {
        TextView heading_text,address,number, veternity_timing ,  sun , mon , tue, wed , thu , fri , sat;
        ...
        public MyView_Holder(View view) {
            ...
            veternity_timing =view.findViewById(R.id.hospital_timing);
