...
public class Clicnic_Fav_Adapter extends RecyclerView.Adapter<Clicnic_Fav_Adapter.My_View_Holder> {
    Context context;
    List<Fav_Response> fav_responses;
    SharedPreferences sharedPreferences;
    String person_id="";
    Clinic_Fav_Fragment clinic_fav_fragment;
    private String language="en";
    private String clinic_id, prevoud_count;
    AlertDialog dialogs;



    public Clicnic_Fav_Adapter(Context context, List<Fav_Response> fav_responses, Clinic_Fav_Fragment clinic_fav_fragment) {
        this.context = context;
        this.fav_responses = fav_responses;
        this.clinic_fav_fragment=clinic_fav_fragment;
    }
    ...
    public void onBindViewHolder(@NonNull My_View_Holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(fav_responses.get(position).getClinic_image()!=null)
        {
            Glide.with(context).load(Api_client.BASE_IMAGE+fav_responses.get(position).getClinic_image()).into(holder.image);
        }
        else
        {
        ...
        holder.number.setText(fav_responses.get(position).getClinicPhone()+"");
        holder.address.setText(fav_responses.get(position).getClinicAddress());
        holder.heading_text.setText(fav_responses.get(position).getClinicName());
        holder.call_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent callIntent = new Intent(Intent.ACTION_DIAL);
                callIntent.setData(Uri.parse("tel:"+fav_responses.get(position).getClinicPhone()));//change the number
        ...
        holder.share_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                share.putExtra(Intent.EXTRA_TEXT, fav_responses.get(position).getClinicName()+"\n"+fav_responses.get(position).getClinicAddress()+"\n"+fav_responses.get(position).getClinicPhone());
//                share.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        holder.location_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("lattitude",fav_responses.get(position).getClinicLatitude());
                intent.putExtra("longitude",fav_responses.get(position).getClinicLongitude());
                intent.putExtra("city",fav_responses.get(position).getClinicCityName());
                intent.putExtra("key","2");
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(intent);
            }
        });
 /* String fav_result=fav_responses.get(position).getFavourite()+"";
...
*/
        ...
        holder.recommen_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                prevoud_count = String.valueOf(fav_responses.get(position).getClinic_recommend());
                clinic_id = String.valueOf(fav_responses.get(position).getClinicId());
        ...
        holder.add_remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String h_id= String.valueOf(fav_responses.get(position).getClinicId());
//                add_favourite_API(position,h_id,holder.add_remove);
    ...
    private void add_favourite_API(int position, String doctor_id) {
        ...
        Call<Advance_Search_Model> call = Api_client.getClient().save_as_favourite_API( "7c538f486ea815187d12c54c3646d71e",person_id,"2",doctor_id,language);
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True")) {
                            Toast.makeText(context, message, Toast.LENGTH_SHORT).show();
                            removeItem(position);
                            clinic_fav_fragment.getFav_API_Data();
    ...
    public class My_View_Holder extends RecyclerView.ViewHolder {
        ...
        ImageView call_icon,location_icon,add_remove,recommen_icon,share_icon,image;
