...
import com.example.findadoc.Fragments.Doctor_Fav_Fragment;
...
public class Doctor_Fav_Adapter extends RecyclerView.Adapter<Doctor_Fav_Adapter.My_View_Holder> {

    Context context;
    List<Fav_Response> fav_responses;
    SharedPreferences sharedPreferences;
    String person_id="";
    private String doctor_id, prevoud_count;
    Doctor_Fav_Fragment doctor_fav_fragment;
    private String language="en";
    AlertDialog dialogs;

    public Doctor_Fav_Adapter(Context context, List<Fav_Response> fav_responses, Doctor_Fav_Fragment doctor_fav_fragment) {
        this.context = context;
        this.fav_responses = fav_responses;
        this.doctor_fav_fragment=doctor_fav_fragment;
    }
    ...
    public void onBindViewHolder(@NonNull My_View_Holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(fav_responses.get(position).getDr_image()!=null)
        {
            Glide.with(context).load(Api_client.BASE_IMAGE+fav_responses.get(position).getDr_image()).into(holder.image);
        }
        else
        {
            Glide.with(context).load(R.drawable.profile).into(holder.image);
        }
        holder.number.setText(fav_responses.get(position).getDrPhone());
        holder.address.setText(fav_responses.get(position).getDrAddress());
        holder.heading_text.setText(fav_responses.get(position).getDrName());
        holder.call_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent callIntent = new Intent(Intent.ACTION_DIAL);
                callIntent.setData(Uri.parse("tel:"+fav_responses.get(position).getDrPhone()));//change the number
        ...
        holder.share_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                share.putExtra(Intent.EXTRA_TEXT, fav_responses.get(position).getDrName()+"\n"+fav_responses.get(position).getDrAddress()+"\n"+fav_responses.get(position).getDrPhone());
//                share.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        holder.location_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("lattitude",fav_responses.get(position).getDrLatitude());
                intent.putExtra("longitude",fav_responses.get(position).getDrLongitude());
                intent.putExtra("city",fav_responses.get(position).getDrCityName());
        ...
        holder.layout_one.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String dr_id= String.valueOf(fav_responses.get(position).getDrId());
...
*/
        holder.recommen_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                prevoud_count = String.valueOf(fav_responses.get(position).getDr_recommend());
                doctor_id = String.valueOf(fav_responses.get(position).getDrId());
        ...
        holder.add_remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String h_id= String.valueOf(fav_responses.get(position).getDrId());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True")) {
                            Toast.makeText(context, message, Toast.LENGTH_SHORT).show();
                            removeItem(position);
                            doctor_fav_fragment.getFav_API_Data();
