...
import com.example.findadoc.Fragments.Hospital_Fav_Fragment;
...
public class Hospital_Fav_Adapter extends RecyclerView.Adapter<Hospital_Fav_Adapter.My_View_Holder> {
    Context context;
    List<Fav_Response> fav_responses;
    SharedPreferences sharedPreferences;
    String person_id="";
    Hospital_Fav_Fragment fragment;
    private String language="en";
    private String hospital_id, prevoud_count;
    AlertDialog dialogs;

    public Hospital_Fav_Adapter(Context context, List<Fav_Response> fav_responses, Hospital_Fav_Fragment hospital_fav_fragment) {
        this.context = context;
        this.fav_responses = fav_responses;
        this.fragment=hospital_fav_fragment;
    }
    ...
    public void onBindViewHolder(@NonNull My_View_Holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(fav_responses.get(position).getHospital_image()!=null)
        {
            Glide.with(context).load(Api_client.BASE_IMAGE+fav_responses.get(position).getHospital_image()).into(holder.image);
        }
        else
        {
            Glide.with(context).load(R.drawable.profile).into(holder.image);
        }
        holder.number.setText(fav_responses.get(position).getHospitalPhone());
        holder.address.setText(fav_responses.get(position).getHospitalAddress());
        holder.heading_text.setText(fav_responses.get(position).getHospitalName());

        holder.call_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent callIntent = new Intent(Intent.ACTION_DIAL);
                callIntent.setData(Uri.parse("tel:"+fav_responses.get(position).getHospitalPhone()));//change the number
        ...
        holder.share_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                share.putExtra(Intent.EXTRA_TEXT, fav_responses.get(position).getHospitalName()+"\n"+fav_responses.get(position).getHospitalAddress()+"\n"+fav_responses.get(position).getHospitalPhone());
//                share.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        holder.location_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("lattitude",fav_responses.get(position).getHospitalLatitude());
                intent.putExtra("longitude",fav_responses.get(position).getHospitalLongitude());
                intent.putExtra("city",fav_responses.get(position).getHospitalCityName());
...
*/
        ...
        holder.recommen_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                prevoud_count = String.valueOf(fav_responses.get(position).getHospital_recommend());
                hospital_id = String.valueOf(fav_responses.get(position).getHospitalId());
                Recommend_API(hospital_id,prevoud_count,person_id);
        ...
        holder.add_remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String h_id=fav_responses.get(position).getHospitalId().toString();
    ...
    private void Recommend_API(String hospital_id, String prevoud_count, String person_id) {
    ...
    private void add_favourite_API(int position, String doctor_id) {
        ...
        Call<Advance_Search_Model> call = Api_client.getClient().save_as_favourite_API( "7c538f486ea815187d12c54c3646d71e",
                person_id,
                "1",
                doctor_id,
                language);
