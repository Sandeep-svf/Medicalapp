...
public class Drug_Store_Adapter extends RecyclerView.Adapter<Drug_Store_Adapter.MyView_Holder> {
    Context context;
    ...
    public  Drug_Store_Adapter(Context context, List<Pharmacies_Data_Response> hospital_resposnes , String key) {
    ...
    public void onBindViewHolder(@NonNull MyView_Holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if(pharmacies_data_responses.get(position).getParapharmacyImage()!=null)
        {
            Glide.with(context).load(
                    Api_client.BASE_IMAGE+pharmacies_data_responses.get(position).
                            getParapharmacyImage()).into(holder.image);
        }
        else
        {
            Glide.with(context).load(
        ...
        holder.number.setText(pharmacies_data_responses.get(position).getParapharmacyPhone());
        holder.address.setText(pharmacies_data_responses.get(position).getParapharmacyAdd());
        holder.heading_text.setText(pharmacies_data_responses.get(position).getParapharmacyName());
        holder.hospital_timing.setText(pharmacies_data_responses.get(position).getParapharmacyTiming());

        String temp = pharmacies_data_responses.get(position).getParapharmacyTiming();
        ...
        holder.call_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callIntent.setData(Uri.parse("tel:"+pharmacies_data_responses.get(position).getParapharmacyPhone()));//change the number
        ...
        holder.share_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                share.putExtra(Intent.EXTRA_TEXT, pharmacies_data_responses.get(position).getParapharmacyName()+"\n"+pharmacies_data_responses.get(position).getParapharmacyAdd()+"\n"+pharmacies_data_responses.get(position).getParapharmacyPhone());
//                share.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        holder.location_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("lattitude",pharmacies_data_responses.get(position).getParapharmacyLatitude());
                intent.putExtra("longitude",pharmacies_data_responses.get(position).getParapharmacyLongitude());
                intent.putExtra("city",pharmacies_data_responses.get(position).getParapharmacyCityName());
        ...
        holder.add_fav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String hospital_id= String.valueOf(pharmacies_data_responses.get(position).getParapharmacyId());
                if(person_id.equals(""))
                {
...
*/
        holder.recommen_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String hosp_id=pharmacies_data_responses.get(position).getParapharmacyId().toString();
                String prevoud_count= String.valueOf(pharmacies_data_responses.get(position).getParapharmacyRecommend());
                if(person_id.equals(""))
                {
                    Intent intent=new Intent(context, Login_Activity.class);
                    context.startActivity(intent);
    ...
    private void add_favourite_API(int position, String hospital_id, ImageView add_fav) {
        ...
        Call<Advance_Search_Model> call = Api_client.getClient().save_as_favourite_API( "7c538f486ea815187d12c54c3646d71e",person_id,"7",hospital_id,language);
