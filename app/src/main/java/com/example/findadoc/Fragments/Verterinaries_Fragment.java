...
public class Verterinaries_Fragment extends Fragment {

    double longitudes,latitudes;
    String currentlatitude="", currentlongtide="";
    Button search_button;
    Switch around_switch;
    SearchableSpinner city_spinner , spinner_country_vert ,spinner_state_vert , spinner_city_vert;
    GPSTracker gps;
    ...
    String language="en";
    RelativeLayout spinner_city_vert_layout,spinner_state_vert_layout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_verterinaries_, container, false);
        spinner_city_vert_layout=v.findViewById(R.id.spinner_city_vert_layout);
        spinner_state_vert_layout=v.findViewById(R.id.spinner_state_vert_layout);
        search_button=v.findViewById(R.id.search_button);
        around_switch=v.findViewById(R.id.around_switch);
        spinner_state_vert=v.findViewById(R.id.spinner_state_vert);
        spinner_country_vert=v.findViewById(R.id.spinner_country_vert);
        spinner_city_vert=v.findViewById(R.id.spinner_city_vert);
        ...
        around_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(around_switch.isChecked())
                {
                    ...
                    sp_id="";
                    spinner_country_vert.setSelection(0);
                    country_sp_id = "";
                    spinner_state_vert.setSelection(0);
                    state_sp_id = "" ;
                    spinner_city_vert.setSelection(0);
                    city_sp_id = "" ;
...
//                    Toast.makeText(getActivity(),currentlatitude+"LL"+currentlongtide,Toast.LENGTH_LONG).show();
        ...
        spinner_country_vert.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                //  Toast.makeText(getActivity(), "Country Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_country_vert.getSelectedItem().toString();
        ...
        spinner_state_vert.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                // Toast.makeText(getActivity(), "State Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_state_vert.getSelectedItem().toString();
        ...
        spinner_city_vert.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                //Toast.makeText(getActivity(), "################### City Spinner Working ##############", Toast.LENGTH_SHORT).show();

                String item = spinner_city_vert.getSelectedItem().toString();
                if (item.equals(getResources().getString(R.string.select_city)))
                {
                    // int spinnerPosition = dAdapter.getPosition(compareValue);
                    // spinner_category.setSelection(Integer.parseInt("Select Category"));
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_city_vert_layout.setVisibility(View.VISIBLE);
                            ...
                            dAdapter.add(getResources().getString(R.string.select_city));
                            spinner_city_vert.setAdapter(dAdapter);
                            spinner_city_vert.setSelection(dAdapter.getCount());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            Log.e("fsdfsdfs", "state api running");

                            spinner_state_vert_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_state_vert.setAdapter(dAdapter);
                            spinner_state_vert.setSelection(dAdapter.getCount());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_country_vert.setAdapter(dAdapter);
                            spinner_country_vert.setSelection(dAdapter.getCount());
