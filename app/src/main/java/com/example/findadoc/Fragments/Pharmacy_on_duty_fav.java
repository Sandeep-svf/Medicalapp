...
import com.example.findadoc.Adapter.Duty_Fav_Adapter;
...
public class Pharmacy_on_duty_fav extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_pharmacy_on_duty_fav, container, false);
    ...
    public void getFav_API_Data() {
        ...
        Call<Fav_Model> call = Api_client.getClient().get_favourite_data( "7c538f486ea815187d12c54c3646d71e",language,user_id,"11");
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            Duty_Fav_Adapter hospital_fav_adapter=new Duty_Fav_Adapter(getActivity(),fav_responses,Pharmacy_on_duty_fav.this);
