...
import com.example.findadoc.Adapter.Drug_Fav_Adapter;
...
public class Parapharmacy_Fav_Fragment extends Fragment {


    RecyclerView drug_fav_recycler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_drug__store__fav_, container, false);
        ...
        drug_fav_recycler=v.findViewById(R.id.drug_fav_fragment);
        layout_rad=v.findViewById(R.id.layout_rad);
        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false);
        drug_fav_recycler.setLayoutManager(linearLayoutManager);
        getFav_API_Data();
        return v;
    }
    public void getFav_API_Data() {
        ...
        Call<Fav_Model> call = Api_client.getClient().get_favourite_data( "7c538f486ea815187d12c54c3646d71e",language,user_id,"7");
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            Drug_Fav_Adapter hospital_fav_adapter=new Drug_Fav_Adapter(getActivity(),fav_responses, Parapharmacy_Fav_Fragment.this);
                            drug_fav_recycler.setAdapter(hospital_fav_adapter);
                            layout_rad.setVisibility(View.GONE);
                            drug_fav_recycler.setVisibility(View.VISIBLE);
                        }else {
                            layout_rad.setVisibility(View.VISIBLE);
                            drug_fav_recycler.setVisibility(View.GONE);
