...
import com.example.findadoc.Adapter.Doctor_Fav_Adapter;
...
public class Doctor_Fav_Fragment extends Fragment {



    LinearLayout layout_doctor;
    RecyclerView fav_doctor_recycler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_doctor__fav_, container, false);
        ...
        fav_doctor_recycler=v.findViewById(R.id.fav_doctor_recycler);
        layout_doctor=v.findViewById(R.id.layout_doctor);
        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false);
        fav_doctor_recycler.setLayoutManager(linearLayoutManager);
        getFav_API_Data();
        return v;
    }
    public void getFav_API_Data() {
        ...
        Call<Fav_Model> call = Api_client.getClient().get_favourite_data( "7c538f486ea815187d12c54c3646d71e",language,user_id,"3");
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            Doctor_Fav_Adapter hospital_fav_adapter=new Doctor_Fav_Adapter(getActivity(),fav_responses,Doctor_Fav_Fragment.this);
                            fav_doctor_recycler.setAdapter(hospital_fav_adapter);
                            layout_doctor.setVisibility(View.GONE);
                            fav_doctor_recycler.setVisibility(View.VISIBLE);
                        }else {
                            layout_doctor.setVisibility(View.VISIBLE);
                            fav_doctor_recycler.setVisibility(View.GONE);
