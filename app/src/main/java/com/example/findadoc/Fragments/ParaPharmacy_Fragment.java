...
public class ParaPharmacy_Fragment extends Fragment {

    double longitudes,latitudes;
    String currentlatitude="", currentlongtide="";
    Button search_button;
    Switch around_switch;
    SearchableSpinner city_spinner , spinner_country_parapharmacy ,spinner_state_parapharmacy , spinner_city_parapharmacy;
    GPSTracker gps;
    ...
    RelativeLayout spinner_city_parapharmacy_layout, spinner_state_parapharmacy_layout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_drugs__store_, container, false);
        search_button=v.findViewById(R.id.search_button);
        spinner_city_parapharmacy_layout=v.findViewById(R.id.spinner_city_parapharmacy_layout);
        spinner_state_parapharmacy_layout=v.findViewById(R.id.spinner_state_parapharmacy_layout);
        around_switch=v.findViewById(R.id.around_switch);
        spinner_country_parapharmacy=v.findViewById(R.id.spinner_country_parapharmacy);
        spinner_state_parapharmacy=v.findViewById(R.id.spinner_state_parapharmacy);
        spinner_city_parapharmacy=v.findViewById(R.id.spinner_city_parapharmacy);
        ...
        around_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(around_switch.isChecked())
                {
                    ...
                    sp_id="";
                    spinner_country_parapharmacy.setSelection(0);
                    country_sp_id = "";
                    spinner_state_parapharmacy.setSelection(0);
                    state_sp_id = "" ;
                    spinner_city_parapharmacy.setSelection(0);
                    city_sp_id = "" ;
...
//                    Toast.makeText(getActivity(),currentlatitude+"LL"+currentlongtide,Toast.LENGTH_LONG).show();
        ...
        spinner_country_parapharmacy.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                //  Toast.makeText(getActivity(), "Country Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_country_parapharmacy.getSelectedItem().toString();
        ...
        spinner_state_parapharmacy.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                // Toast.makeText(getActivity(), "State Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_state_parapharmacy.getSelectedItem().toString();
        ...
        spinner_city_parapharmacy.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

               // Toast.makeText(getActivity(), "################### City Spinner Working ##############", Toast.LENGTH_SHORT).show();

                String item = spinner_city_parapharmacy.getSelectedItem().toString();
                if (item.equals(getResources().getString(R.string.select_city)))
                {
                    // int spinnerPosition = dAdapter.getPosition(compareValue);
                    // spinner_category.setSelection(Integer.parseInt("Select Category"));
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_city_parapharmacy_layout.setVisibility(View.VISIBLE);
                            ...
                            dAdapter.add(getResources().getString(R.string.select_city));
                            spinner_city_parapharmacy.setAdapter(dAdapter);
                            spinner_city_parapharmacy.setSelection(dAdapter.getCount());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_state_parapharmacy_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_state_parapharmacy.setAdapter(dAdapter);
                            spinner_state_parapharmacy.setSelection(dAdapter.getCount());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_country_parapharmacy.setAdapter(dAdapter);
                            spinner_country_parapharmacy.setSelection(dAdapter.getCount());
