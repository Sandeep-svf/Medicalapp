...
import com.example.findadoc.Adapter.Opticiens_fav_Adapter;
...
public class Opticiens_Favourite_Fragmenet extends Fragment {


    RecyclerView opticiense_fav_recycler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_opticiens__favourite__fragmenet, container, false);
        ...
        opticiense_fav_recycler=v.findViewById(R.id.opticiense_fav_recycler);
        layout_rad=v.findViewById(R.id.layout_rad);
        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false);
        opticiense_fav_recycler.setLayoutManager(linearLayoutManager);
        getFav_API_Data();
        return v;
    }
    public void getFav_API_Data() {
        ...
        Call<Fav_Model> call = Api_client.getClient().get_favourite_data( "7c538f486ea815187d12c54c3646d71e",language,user_id,"8");
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            Opticiens_fav_Adapter hospital_fav_adapter=new Opticiens_fav_Adapter(getActivity(),fav_responses,Opticiens_Favourite_Fragmenet.this);
                            opticiense_fav_recycler.setAdapter(hospital_fav_adapter);
                            layout_rad.setVisibility(View.GONE);
                            opticiense_fav_recycler.setVisibility(View.VISIBLE);
                        }else {
                            layout_rad.setVisibility(View.VISIBLE);
                            opticiense_fav_recycler.setVisibility(View.GONE);
