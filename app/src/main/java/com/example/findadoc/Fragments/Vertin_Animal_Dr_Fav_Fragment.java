...
public class Vertin_Animal_Dr_Fav_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_vertin__animal__dr__fav_, container, false);
    ...
    public void getFav_API_Data() {
        ...
        Call<Fav_Model> call = Api_client.getClient().get_favourite_data( "7c538f486ea815187d12c54c3646d71e",language,user_id,"9");
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            Vert_Anim_Fav_Adapter hospital_fav_adapter=new Vert_Anim_Fav_Adapter(getActivity(),fav_responses,Vertin_Animal_Dr_Fav_Fragment.this);
