...
public class Opticiens_Fragment extends Fragment {
    double longitudes,latitudes;
    String currentlatitude="", currentlongtide="";
    Button search_button;
    Switch around_switch;
    SearchableSpinner city_spinner  , spinner_country_opt ,spinner_state_opt , spinner_city_opt;
    GPSTracker gps;
    ...
    RelativeLayout spinner_state_opt_layout, spinner_city_opt_layout;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_opticiens_, container, false);
        search_button=v.findViewById(R.id.search_button);
        around_switch=v.findViewById(R.id.around_switch);
        spinner_state_opt_layout=v.findViewById(R.id.spinner_state_opt_layout);
        spinner_city_opt_layout=v.findViewById(R.id.spinner_city_opt_layout);
        city_spinner=v.findViewById(R.id.city_spinner);
        spinner_country_opt=v.findViewById(R.id.spinner_country_opt);
        spinner_state_opt=v.findViewById(R.id.spinner_state_opt);
        spinner_city_opt=v.findViewById(R.id.spinner_city_opt);
        ...
        around_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(around_switch.isChecked())
                {
                    ...
                    sp_id="";
                    spinner_country_opt.setSelection(0);
                    country_sp_id = "";
                    spinner_state_opt.setSelection(0);
                    state_sp_id = "" ;
                    spinner_city_opt.setSelection(0);
                    city_sp_id = "" ;
...
//                    Toast.makeText(getActivity(),currentlatitude+"LL"+currentlongtide,Toast.LENGTH_LONG).show();
        ...
        spinner_country_opt.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                //  Toast.makeText(getActivity(), "Country Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_country_opt.getSelectedItem().toString();
        ...
        spinner_state_opt.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                // Toast.makeText(getActivity(), "State Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_state_opt.getSelectedItem().toString();
        ...
        spinner_city_opt.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

               // Toast.makeText(getActivity(), "################### City Spinner Working ##############", Toast.LENGTH_SHORT).show();

                String item = spinner_city_opt.getSelectedItem().toString();
                if (item.equals(getResources().getString(R.string.select_city)))
                {
                    // int spinnerPosition = dAdapter.getPosition(compareValue);
                    // spinner_category.setSelection(Integer.parseInt("Select Category"));
...
/*                            CustomAdapter customAdapter=new CustomAdapter(getActivity(),cityList);
            ...
            public void onResponse(Call<City_Model> call, Response<City_Model> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            spinner_city_opt_layout.setVisibility(View.VISIBLE);
                            ...
                            dAdapter.add(getResources().getString(R.string.select_city));
                            spinner_city_opt.setAdapter(dAdapter);
                            spinner_city_opt.setSelection(dAdapter.getCount());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_state_opt_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_state_opt.setAdapter(dAdapter);
                            spinner_state_opt.setSelection(dAdapter.getCount());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_country_opt.setAdapter(dAdapter);
                            spinner_country_opt.setSelection(dAdapter.getCount());
    ...
    public void onResume() {
        ...
        spinner_state_opt_layout.setVisibility(View.GONE);
        spinner_city_opt_layout.setVisibility(View.GONE);
    }
}