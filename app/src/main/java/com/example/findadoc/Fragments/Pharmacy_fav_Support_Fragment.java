...
import com.example.findadoc.Adapter.Pharmacy_Supoort_Fav_Adapter;
...
public class Pharmacy_fav_Support_Fragment extends Fragment {


    RecyclerView pharmacy_fav_recycler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_pharmacy_fav__support_, container, false);
        ...
        pharmacy_fav_recycler=v.findViewById(R.id.pharmacy_fav_recycler);
        layout_rad=v.findViewById(R.id.layout_rad);
        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false);
        pharmacy_fav_recycler.setLayoutManager(linearLayoutManager);
        getFav_API_Data();
        return v;
    }
    public void getFav_API_Data() {
        ...
        Call<Fav_Model> call = Api_client.getClient().get_favourite_data( "7c538f486ea815187d12c54c3646d71e",language,user_id,"6");
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            Pharmacy_Supoort_Fav_Adapter hospital_fav_adapter=new Pharmacy_Supoort_Fav_Adapter(getActivity(),fav_responses,Pharmacy_fav_Support_Fragment.this);
                            pharmacy_fav_recycler.setAdapter(hospital_fav_adapter);
                            layout_rad.setVisibility(View.GONE);
                            pharmacy_fav_recycler.setVisibility(View.VISIBLE);
                        }else {
                            layout_rad.setVisibility(View.VISIBLE);
                            pharmacy_fav_recycler.setVisibility(View.GONE);
