...
public class Pharmacy_on_duty extends Fragment {

    double longitudes,latitudes;
    String currentlatitude="", currentlongtide="";
    Button search_button;
    Switch around_switch;
    SearchableSpinner city_spinner  , spinner_country_pharmacy_on_duity ,spinner_state_pharmacy_on_duity , spinner_city_pharmacy_on_duity;
    GPSTracker gps;
    ...
    RelativeLayout spinner_city_pharmacy_on_duity_layout, spinner_state_pharmacy_on_duity_layout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_pharmacy_on_duty, container, false);
        search_button=v.findViewById(R.id.search_button);
        around_switch=v.findViewById(R.id.around_switch);
        spinner_city_pharmacy_on_duity_layout=v.findViewById(R.id.spinner_city_pharmacy_on_duity_layout);
        spinner_state_pharmacy_on_duity_layout=v.findViewById(R.id.spinner_state_pharmacy_on_duity_layout);
        city_spinner=v.findViewById(R.id.city_spinner);
        spinner_country_pharmacy_on_duity=v.findViewById(R.id.spinner_country_pharmacy_on_duity);
        spinner_state_pharmacy_on_duity=v.findViewById(R.id.spinner_state_pharmacy_on_duity);
        spinner_city_pharmacy_on_duity=v.findViewById(R.id.spinner_city_pharmacy_on_duity);
        around_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(around_switch.isChecked())
                {
                    ...
                    sp_id="";
                    spinner_country_pharmacy_on_duity.setSelection(0);
                    country_sp_id = "";
                    spinner_state_pharmacy_on_duity.setSelection(0);
                    state_sp_id = "" ;
                    spinner_city_pharmacy_on_duity.setSelection(0);
                    city_sp_id = "" ;
...
//                    Toast.makeText(getActivity(),currentlatitude+"LL"+currentlongtide,Toast.LENGTH_LONG).show();
        ...
        spinner_country_pharmacy_on_duity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                //  Toast.makeText(getActivity(), "Country Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_country_pharmacy_on_duity.getSelectedItem().toString();
        ...
        spinner_state_pharmacy_on_duity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                // Toast.makeText(getActivity(), "State Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_state_pharmacy_on_duity.getSelectedItem().toString();
        ...
        spinner_city_pharmacy_on_duity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

               // Toast.makeText(getActivity(), "################### City Spinner Working ##############", Toast.LENGTH_SHORT).show();

                String item = spinner_city_pharmacy_on_duity.getSelectedItem().toString();
                if (item.equals(getResources().getString(R.string.select_city)))
                {
                    // int spinnerPosition = dAdapter.getPosition(compareValue);
                    // spinner_category.setSelection(Integer.parseInt("Select Category"));
        ...
        search_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((!around_switch.isChecked()) && ( city_sp_id.equals("")) )
                {
                    popup();
            ...
            public void onResponse(Call<City_Model> call, Response<City_Model> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        {
                            spinner_city_pharmacy_on_duity_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_city_pharmacy_on_duity.setAdapter(dAdapter);
                            spinner_city_pharmacy_on_duity.setSelection(dAdapter.getCount());
            ...
            public void onResponse(Call<State_Model> call, Response<State_Model> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            spinner_state_pharmacy_on_duity_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_state_pharmacy_on_duity.setAdapter(dAdapter);
                            spinner_state_pharmacy_on_duity.setSelection(dAdapter.getCount());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_country_pharmacy_on_duity.setAdapter(dAdapter);
                            spinner_country_pharmacy_on_duity.setSelection(dAdapter.getCount());
