...
public class Hospital_Fragment extends Fragment {
    ...
    Switch switch_my,recomended_switch;
    String recopmmedn="";
    String search_text="";
    EditText keyword;
    ...
    RelativeLayout spinner_city_layout,spinner_state_layout;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_hospital_, container, false);
        spinner_state_layout=v.findViewById(R.id.spinner_state_layout);
        spinner_city_layout=v.findViewById(R.id.spinner_city_layout);
        search_btn=v.findViewById(R.id.search);
        ...
        switch_my=v.findViewById(R.id.switch_my);
        ...
        recomended_switch=v.findViewById(R.id.recomended_switch);


       // spinner_country.setTitle(String.valueOf(R.string.select_item));


        switch_my.setChecked(false);
        recomended_switch.setChecked(false);
        switch_my.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(switch_my.isChecked())
                {
                    ...
                    {
                        gps.showSettingsAlert(switch_my);
                    }
...
//                    Toast.makeText(getActivity(),currentlatitude+"LL"+currentlongtide,Toast.LENGTH_LONG).show();
      ...
      recomended_switch.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
              if(recomended_switch.isChecked())
              {
...
//                  Toast.makeText(getActivity(), recopmmedn, Toast.LENGTH_SHORT).show();
        ...
        search_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((!switch_my.isChecked()) && (!recomended_switch.isChecked() && city_sp_id.equals("") || recomended_switch.isChecked() && city_sp_id.equals(""))  )
                {
                    popup();
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_city_layout.setVisibility(View.VISIBLE);
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_state_layout.setVisibility(View.VISIBLE);
