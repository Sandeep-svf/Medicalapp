...
public class Radiology_Fragment extends Fragment {

    SearchableSpinner city_spinner , spinner_country_radiology ,spinner_state_radiology , spinner_city_radiology;
    ...
    RelativeLayout spinner_state_radiology_layout, spinner_city_radiology_layout;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        spinner_state_radiology_layout=v.findViewById(R.id.spinner_state_radiology_layout);
        city_spinner=v.findViewById(R.id.spinner);
        spinner_city_radiology_layout=v.findViewById(R.id.spinner_city_radiology_layout);
        spinner_city_radiology=v.findViewById(R.id.spinner_city_radiology);
        spinner_country_radiology=v.findViewById(R.id.spinner_country_radiology);
        around_switch=v.findViewById(R.id.around_switch);
        spinner_state_radiology=v.findViewById(R.id.spinner_state_radiology);
        ...
        around_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(around_switch.isChecked())
                {
                    ...
                    sp_id="";
                    spinner_country_radiology.setSelection(0);
                    country_sp_id = "";
                    spinner_state_radiology.setSelection(0);
                    state_sp_id = "" ;
                    spinner_city_radiology.setSelection(0);
                    city_sp_id = "" ;
...
//                    Toast.makeText(getActivity(), recopmmedn, Toast.LENGTH_SHORT).show();
        ...
        spinner_country_radiology.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                //  Toast.makeText(getActivity(), "Country Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_country_radiology.getSelectedItem().toString();
        ...
        spinner_state_radiology.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                // Toast.makeText(getActivity(), "State Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_state_radiology.getSelectedItem().toString();
        ...
        spinner_city_radiology.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

               // Toast.makeText(getActivity(), "################### City Spinner Working ##############", Toast.LENGTH_SHORT).show();

                String item = spinner_city_radiology.getSelectedItem().toString();
                if (item.equals(getResources().getString(R.string.select_city)))
                {
                    // int spinnerPosition = dAdapter.getPosition(compareValue);
                    // spinner_category.setSelection(Integer.parseInt("Select Category"));
            ...
            public void onResponse(Call<City_Model> call, Response<City_Model> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            spinner_city_radiology_layout.setVisibility(View.VISIBLE);
                            ...
                            dAdapter.add(getResources().getString(R.string.select_city));
                            spinner_city_radiology.setAdapter(dAdapter);
                            spinner_city_radiology.setSelection(dAdapter.getCount());
            ...
            public void onResponse(Call<State_Model> call, Response<State_Model> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            spinner_state_radiology_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_state_radiology.setAdapter(dAdapter);
                            spinner_state_radiology.setSelection(dAdapter.getCount());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_country_radiology.setAdapter(dAdapter);
                            spinner_country_radiology.setSelection(dAdapter.getCount());
