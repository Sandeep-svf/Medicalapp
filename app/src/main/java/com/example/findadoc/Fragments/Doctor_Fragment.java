...
public class Doctor_Fragment extends Fragment {
    ...
    SearchableSpinner city_spinner , spinner_country_doctor ,spinner_state_doctor , spinner_city_doctor;
    ...
    Switch recommend_switch,around_switch;
    ...
    String language="en";
    RelativeLayout spinner_state_doctor_layout, spinner_city_doctor_layout;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_doctor_, container, false);
        spinner_city_doctor_layout=v.findViewById(R.id.spinner_city_doctor_layout);
        spinner_state_doctor_layout=v.findViewById(R.id.spinner_state_doctor_layout);
        city_spinner=v.findViewById(R.id.city_spinner);
        spinner_state_doctor=v.findViewById(R.id.spinner_state_doctor);
        spinner_country_doctor=v.findViewById(R.id.spinner_country_doctor);
        spinner_city_doctor=v.findViewById(R.id.spinner_city_doctor);
        ...
        around_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(around_switch.isChecked())
                {
                    ...
                    sp_id="";
                    spinner_country_doctor.setSelection(0);
                    country_sp_id = "";
                    spinner_state_doctor.setSelection(0);
                    state_sp_id = "" ;
                    spinner_city_doctor.setSelection(0);
                    city_sp_id = "" ;
...
//                    Toast.makeText(getActivity(),currentlatitude+"LL"+currentlongtide,Toast.LENGTH_LONG).show();
        ...
        spinner_country_doctor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                //  Toast.makeText(getActivity(), "Country Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_country_doctor.getSelectedItem().toString();
        ...
        spinner_state_doctor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                // Toast.makeText(getActivity(), "State Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_state_doctor.getSelectedItem().toString();
        ...
        spinner_city_doctor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

              //  Toast.makeText(getActivity(), "################### City Spinner Working ##############", Toast.LENGTH_SHORT).show();

                String item = spinner_city_doctor.getSelectedItem().toString();
                if (item.equals(getResources().getString(R.string.select_city)))
                {
                    // int spinnerPosition = dAdapter.getPosition(compareValue);
                    // spinner_category.setSelection(Integer.parseInt("Select Category"));
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_city_doctor_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_city_doctor.setAdapter(dAdapter);
                            spinner_city_doctor.setSelection(dAdapter.getCount());
            ...
            public void onResponse(Call<State_Model> call, Response<State_Model> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            spinner_state_doctor_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_state_doctor.setAdapter(dAdapter);
                            spinner_state_doctor.setSelection(dAdapter.getCount());
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                           ...
                           spinnerAdapter dAdapter = new spinnerAdapter(getActivity(), R.layout.custom_spinner_two, country_name_list);
                            ...
                            spinner_country_doctor.setAdapter(dAdapter);
                            spinner_country_doctor.setSelection(dAdapter.getCount());
...
//                            Toast.makeText(getActivity(),success,Toast.LENGTH_LONG).show();
                            ...
                            Log.e("LIST",city_name_list.size()+"S");
...
//                            Toast.makeText(getActivity(),success,Toast.LENGTH_LONG).show();
                            ...
                            doctorSpecialty.setDoctorSpecialtyName(getResources().getString(R.string.selct_spec));
                            ...
                            specialist_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                ...
                                public void onItemSelected(AdapterView<?> parnet, View view, int position, long id) {
                                      clinic_id= String.valueOf(doctorSpecialties.get(position).getDoctorSpecialityId());
