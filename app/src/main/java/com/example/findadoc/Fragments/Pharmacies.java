...
public class Pharmacies extends Fragment {
    ...
    SearchableSpinner city_spinner , spinner_country_pharmacy ,spinner_state_pharmacy , spinner_city_pharmacy;
    GPSTracker gps;
    ...
    RelativeLayout spinner_city_pharmacy_layout, spinner_state_pharmacy_layout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        spinner_city_pharmacy_layout=v.findViewById(R.id.spinner_city_pharmacy_layout);
        spinner_state_pharmacy_layout=v.findViewById(R.id.spinner_state_pharmacy_layout);
        city_spinner=v.findViewById(R.id.city_spinner);
        spinner_country_pharmacy=v.findViewById(R.id.spinner_country_pharmacy);
        spinner_state_pharmacy=v.findViewById(R.id.spinner_state_pharmacy);
        spinner_city_pharmacy=v.findViewById(R.id.spinner_city_pharmacy);
        around_switch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(around_switch.isChecked())
                {
                    ...
                    sp_id="";
                    spinner_country_pharmacy.setSelection(0);
                    country_sp_id = "";
                    spinner_state_pharmacy.setSelection(0);
                    state_sp_id = "" ;
                    spinner_city_pharmacy.setSelection(0);
                    city_sp_id = "" ;
...
//                    Toast.makeText(getActivity(),currentlatitude+"LL"+currentlongtide,Toast.LENGTH_LONG).show();
        ...
        spinner_country_pharmacy.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                //  Toast.makeText(getActivity(), "Country Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_country_pharmacy.getSelectedItem().toString();
        ...
        spinner_state_pharmacy.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                // Toast.makeText(getActivity(), "State Spinner Working **********", Toast.LENGTH_SHORT).show();

                String item = spinner_state_pharmacy.getSelectedItem().toString();
        ...
        spinner_city_pharmacy.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                //Toast.makeText(getActivity(), "################### City Spinner Working ##############", Toast.LENGTH_SHORT).show();

                String item = spinner_city_pharmacy.getSelectedItem().toString();
                if (item.equals(getResources().getString(R.string.select_city)))
                {
                    // int spinnerPosition = dAdapter.getPosition(compareValue);
                    // spinner_category.setSelection(Integer.parseInt("Select Category"));
            ...
            public void onResponse(Call<City_Model> call, Response<City_Model> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        {
                            spinner_city_pharmacy_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_city_pharmacy.setAdapter(dAdapter);
                            spinner_city_pharmacy.setSelection(dAdapter.getCount());
            ...
            public void onResponse(Call<State_Model> call, Response<State_Model> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            spinner_state_pharmacy_layout.setVisibility(View.VISIBLE);
                            ...
                            spinner_state_pharmacy.setAdapter(dAdapter);
                            spinner_state_pharmacy.setSelection(dAdapter.getCount());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true") || success.equals("True"))
                        {
                            ...
                            spinner_country_pharmacy.setAdapter(dAdapter);
                            spinner_country_pharmacy.setSelection(dAdapter.getCount());
